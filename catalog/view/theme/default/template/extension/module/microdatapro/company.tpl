...
<time itemprop="opens" content="<?php echo $oh['open']; ?>"></time>
<time itemprop="closes" content="<?php echo $oh['close']; ?>"></time>
</span>
<?php } ?>
<?php } ?>
</span>
...
<span class="vcard">
<span class="fn"><span class="value-title" title="<?php echo $organization_name; ?>"></span></span>
...
<span class="priceRange"><span class="value-title" title="<?php echo $code; ?>"></span></span>
</span>
