...
<!-- 
          ...
          <div class="checkout-content" style="overflow: hidden; display: block;">
            ...
            <div class="fields-group">
              ...
              <input type="tel" id="telephone-ch" name="telephone" value="<?php echo $telephone; ?>" 
              ...
              <label for="delivery">  <?=$text_delivery_method?>:</label><br>
                <select onChange="updateShipping(this)" name="shipping_method" id="shipping-method" class="form-control large-field">
                  <?php foreach ($shippig_methods as $shipping_method) { ?>
                    <option value='{"title": "<?php echo $shipping_method["title"] ?>", "code": "<?php echo $shipping_method["value"] ?>", "comment":"", "shipping_method":"<?php echo $shipping_method["value"] ?>", "cost":"<?php echo $shipping_method["cost"] ?>","tax_class_id":""}'
                    class="form-control large-field <?= substr($shipping_method['value'], strpos($shipping_method['value'], '.')+1 )?>"><?php echo $shipping_method['title'] ?>
            ...
            <div class="fields-group" style="">
              ...
              <select id="payment_select" name="payment_method" class="form-control large-field">
                ...
                <option
                  ...
                  style=""><?php echo $payment_method['title'] ?>
                  
                </option>

                <option

                  value='{"title": "<?php echo $text_payment_method_option ?>", "code": "<?php echo $payment_method['code'] ?>"}'
                  class="payment_method_value <?php echo $payment_method['code']?>"
                  style=""><?php echo $text_payment_method_option ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 checkout-data">
          ...
          <div class="cart-info table-responsive">
              ...
              <tbody class="tbody">
                ...
                <tr>
                  <td class="name">
                    ...
                    <div class="p-model"><?php echo $product['model'] ?></div>
            ...
            <div id="confirm">
              <div class="payment">
                  <div id="ajax-button-confirm" class=" btn btn-lg btn-success"><?=$text_confirm?></div>
                  <a href='index.php?route=checkout/cart'>
                    <div id="button-modify" class=" btn btn-lg btn-cancel"><?=$text_cart?></div>
                  </a>
              </div>
            </div>
          </div>
