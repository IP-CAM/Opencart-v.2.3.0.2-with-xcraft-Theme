...
$_['text_svyaz']	    = 'Для Ваших побажань та пропозицій';
$_['text_magazin']	    = 'Магазин відлагоджувальних плат';
$_['text_slogan']	    = 'Чекаемо на Ваші замовлення Он-Лайн цілодобово!';
$_['text_slogan2']		= 'Якщо Ви зробите замовлення після 22.00 вечора ми зв\'яжемося з Вами з 9 до 11 ранку наступного дня';